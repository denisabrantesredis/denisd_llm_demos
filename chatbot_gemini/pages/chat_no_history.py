...
user_session = ''.join(random.choices(string.ascii_letters, k=7))
    ...
    with input_panel:
        ...
        with panel2:
            ...
            with link_panel:
                ...
                with panel2:
                    st.page_link("pages/chat.py", label="Chat - History", icon="✅")


    st.title("AI Chatbot - no history")

    if not st.session_state.history:
        initial_bot_message = "Hello! How can I assist you today? PS: I don't keep any memory of previous questions"
